        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleType = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ad_Articles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ad_Articles_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ad_Articles_Articles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentAriticles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentAriticles_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentAriticles_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ad_Articles_AdId",
                table: "Ad_Articles",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_Ad_Articles_ArticleId",
                table: "Ad_Articles",
                column: "ArticleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentAriticles_ArticleId",
                table: "CommentAriticles",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentAriticles_CommentId",
                table: "CommentAriticles",
                column: "CommentId");
